...
import com.school.langevr004.kungsleden.expandableListAdapter.ExpandableListAdapterLocal;
...
public class OverviewFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        groups = new String[] { "KUNGSLEDEN", "THE CHALLENGE", "PUBLIC TRANSPORT", "ACCOMMODATION AND SERVICES" };
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        lv.setAdapter(new ExpandableListAdapterLocal(groups, children, getActivity()));
