...
public class GeoObject {
    ...
    public static final Cabin[] PRE_DEFINED_CABINS = {
            ...
            new Cabin(PRE_DEFINED_CABIN_OBJECT_POINT[2],PRE_DEFINED_GEO_OBJECT_NAMES[2], "description", PRE_DEFINED_GEO_OBJECT_IMAGE_IDS[2]),
            new Cabin(PRE_DEFINED_CABIN_OBJECT_POINT[3],PRE_DEFINED_GEO_OBJECT_NAMES[3], "description", PRE_DEFINED_GEO_OBJECT_IMAGE_IDS[3]),
            new Cabin(PRE_DEFINED_CABIN_OBJECT_POINT[4],PRE_DEFINED_GEO_OBJECT_NAMES[4], "description", PRE_DEFINED_GEO_OBJECT_IMAGE_IDS[4]),
            new Cabin(PRE_DEFINED_CABIN_OBJECT_POINT[5],PRE_DEFINED_GEO_OBJECT_NAMES[5], "description", PRE_DEFINED_GEO_OBJECT_IMAGE_IDS[5]),
            new Cabin(PRE_DEFINED_CABIN_OBJECT_POINT[6],PRE_DEFINED_GEO_OBJECT_NAMES[6], "description", PRE_DEFINED_GEO_OBJECT_IMAGE_IDS[6]),
            new Cabin(PRE_DEFINED_CABIN_OBJECT_POINT[7],PRE_DEFINED_GEO_OBJECT_NAMES[7], "description", PRE_DEFINED_GEO_OBJECT_IMAGE_IDS[7]),
            new Cabin(PRE_DEFINED_CABIN_OBJECT_POINT[8],PRE_DEFINED_GEO_OBJECT_NAMES[8], "description", PRE_DEFINED_GEO_OBJECT_IMAGE_IDS[8]),
            new Cabin(PRE_DEFINED_CABIN_OBJECT_POINT[9],PRE_DEFINED_GEO_OBJECT_NAMES[9], "description", PRE_DEFINED_GEO_OBJECT_IMAGE_IDS[9]),
            new Cabin(PRE_DEFINED_CABIN_OBJECT_POINT[10],PRE_DEFINED_GEO_OBJECT_NAMES[10], "description", PRE_DEFINED_GEO_OBJECT_IMAGE_IDS[10]),
            new Cabin(PRE_DEFINED_CABIN_OBJECT_POINT[11],PRE_DEFINED_GEO_OBJECT_NAMES[11], "description", PRE_DEFINED_GEO_OBJECT_IMAGE_IDS[11]),
            new Cabin(PRE_DEFINED_CABIN_OBJECT_POINT[12],PRE_DEFINED_GEO_OBJECT_NAMES[12], "description", PRE_DEFINED_GEO_OBJECT_IMAGE_IDS[12]),
            new Cabin(PRE_DEFINED_CABIN_OBJECT_POINT[13],PRE_DEFINED_GEO_OBJECT_NAMES[13], "description", PRE_DEFINED_GEO_OBJECT_IMAGE_IDS[13]),
            new Cabin(PRE_DEFINED_CABIN_OBJECT_POINT[14],PRE_DEFINED_GEO_OBJECT_NAMES[14], "description", PRE_DEFINED_GEO_OBJECT_IMAGE_IDS[14]),
            new Cabin(PRE_DEFINED_CABIN_OBJECT_POINT[15],PRE_DEFINED_GEO_OBJECT_NAMES[15], "description", PRE_DEFINED_GEO_OBJECT_IMAGE_IDS[15]),
            new Cabin(PRE_DEFINED_CABIN_OBJECT_POINT[16],PRE_DEFINED_GEO_OBJECT_NAMES[16], "description", PRE_DEFINED_GEO_OBJECT_IMAGE_IDS[16]),
